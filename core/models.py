...
class Zamowienie(models.Model):
    ...
    kwatera = models.CharField(max_length=200, null=True, blank=True)
    rząd = models.IntegerField(null=True, blank=True)
    nr_grobu = models.IntegerField(null=True, blank=True)
