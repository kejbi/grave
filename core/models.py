...
class Zamowienie(models.Model):
    ...
    usluga = models.CharField(choices=USLUGI, max_length=100, null=False, blank=False)
    rodzaj_grobu = models.CharField(choices=RODZAJE_GROBOW, max_length=100, null=False, blank=False)
    czestotliwosc = models.CharField(choices=CZESTOTLIWOSCI, max_length=100, null=False, blank=False)
